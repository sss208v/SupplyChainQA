  ...
  <div class="knowledge-page">
          ...
          <div class="stat-card">
            ...
            <div>
              <div class="stat-value">
                {{ knowledgeStore.stats.total_chunks }}
              </div>
      ...
      <el-col :span="8">
        <el-card shadow="hover">
          <div class="stat-card">
            ...
            <div>
              <div class="stat-value">
                {{ knowledgeStore.stats.embedding_model }}
              </div>
      ...
      <el-col :span="8">
        <el-card shadow="hover">
          <div class="stat-card">
            ...
            <div>
              <div class="stat-value">
                {{ knowledgeStore.stats.embedding_dimension }}
              </div>
    ...
    <el-card v-permission="'knowledge:upload'" class="upload-card">
      <template #header>
        <div class="card-header">
          <span
            ><el-icon><Upload /></el-icon> 上传文档</span
          >
        </div>
      </template>
    ...
    <el-card class="doc-list-card">
      <template #header>
        <div class="card-header">
          <span
            ><el-icon><Folder /></el-icon> 文档列表</span
          >
...
async function handleUpload() {
  ...
  for (const file of pendingFiles.value) {
    try {
      ...
      ElMessage.success(
        `文档 ${res.filename} 上传成功，已索引 ${res.chunk_count} 个切片`
      );
    } catch (err) {
...
@media (max-width: 767px) {
  ...
  .knowledge-page .el-upload-dragger {
    width: 100%;
    padding: 20px 10px;
  }
  .knowledge-page .el-table {
    font-size: 12px;
  }
  .knowledge-page .el-table .cell {
    padding: 6px 4px;
  }
}
</style>
